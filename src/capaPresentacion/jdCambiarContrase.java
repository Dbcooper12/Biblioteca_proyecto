...
public class jdCambiarContrase extends javax.swing.JDialog {
    clsUsuario objUsuario=new clsUsuario();
    public String usuarioActual;
    
    public jdCambiarContrase(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdCambiarContrase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdCambiarContrase dialog = new jdCambiarContrase(new javax.swing.JFrame(), true);
