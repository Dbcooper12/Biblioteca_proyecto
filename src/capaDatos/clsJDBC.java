...
public class clsJDBC {
    ...
    public ResultSet consultarBD (String strSQL) throws Exception{
        ...
        try {
            ...
            throw new Exception("Error al ejecutar consultallll");
        } finally{
            if (con!=null){
                desconectar();
            }
    ...
    public void ejecutarBD (String strSQL) throws Exception{
        try {
            ...
            throw new Exception("Error al ejecutar consulta222");
        } finally{
            if (con!=null){
                desconectar();
            }
    ...
    public void ejecutarBDTransacciones (String strSQL1,String strSQL2,String strSQL3) throws Exception{
        try {
            ...
            con.rollback();
            throw new Exception("Error al ejecutar consulta21212");
        } finally{
            if (con!=null){
                desconectar();
            }
